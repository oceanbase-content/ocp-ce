...
OCP V4.3.2 正式发布，全面兼容 OceanBase V4.3.2 及其以下版本。该版本新增重要功能 **租户克隆**，可有效解决数据库变更、应用版本发布、快速构建开发测试环境等多种业务场景下的数据隔离及效率问题。同时，此版本支持 CPU 绑核，通过合理设置来显著提升数据库在 ARM 混部场景下的集群性能。此外，该版本还实现对 OBKV_Table 和 OBKV_HBase 的监控功能，方便用户更好地监控产品性能。不仅如此，本版本在基础运维、性能监控、运维配置、外部集成等方面进行了超 20 项的优化和增强，并基于用户体验提升了产品的易用性和稳定性，以协助用户更高效地管理 OceanBase 数据库。
