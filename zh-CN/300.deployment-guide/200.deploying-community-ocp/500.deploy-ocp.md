...
* 已参见 [安装准备](400.installation-preparation.md) 获取 `ocp-all-in-one-4.4.2-YYYYMMDDhhmmss.el7.x86_64.tar.gz` 软件包，将软件包上传至 OCP 宿主机的任一目录，并执行如下命令进行解压。
