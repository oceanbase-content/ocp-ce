...
<main id="notice" type='explain'>
<h4>说明</h4>
<p>当集群为 AI 集群（共享存储形态）时，Unit 规格中会额外包含如下字段：<ul><li><b>DATA_DISK_SIZE</b>：缓存盘空间大小，默认值为 MAX(min cpu * 2GB, memory size * 2)，最小值为 2 * cpu（GB）。</li><li><b>MAX_NET_BANDWIDTH</b>：最大网络带宽。</li></ul></p>
</main>
