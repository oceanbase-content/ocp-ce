...
| CREATE ROUTINE   | 创建 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.1.0, +∞)</li></p></main>      |
| EXECUTE   | 执行 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.1.0, +∞)</li></p></main>       |
| ALTER ROUTINE   | 修改和删除 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.1.0, +∞)</li></p></main>    |
| PROCESS   | `PROCESS` 的权限。   |
...
| CREATE VIEW    | 创建、删除视图的权限。                                            |
| SHOW VIEW      | `SHOW CREATE VIEW` 权限。                                        |
| CREATE ROUTINE   | 创建 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.2.0, +∞)</li></p></main>    |
| ALTER ROUTINE   | 修改和删除 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.2.0, +∞)</li></p></main>    |
| EXECUTE   | 执行 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2.0, V4.3.0.0)</li><li>[V4.3.2.0, +∞)</li></p></main>       |
| REFERENCES     | 创建外键的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.4.0, V4.3.0.0)</li><li>[V4.3.3.0, +∞)</li></p></main>    |
