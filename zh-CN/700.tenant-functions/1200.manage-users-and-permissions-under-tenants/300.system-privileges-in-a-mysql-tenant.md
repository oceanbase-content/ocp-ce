...
| EXECUTE   | 执行 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2, V4.3.0)</li><li>[V4.3.2, +∞)</li></p></main>       |
...
| ALTER ROUTINE   | 修改和删除 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2, V4.3.0)</li><li>[V4.3.1, +∞)</li></p></main>    |
| EXECUTE   | 执行 `PROCEDURE` 和 `FUNCTION` 的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.2, V4.3.0)</li><li>[V4.3.2, +∞)</li></p></main>       |
| REFERENCES     | 创建外键的权限。<main id="notice" type='explain'><h4>说明</h4><p>该参数仅适用于如下 OceanBase 版本：<li>[V4.2.4, V4.3.0)</li><li>[V4.3.3, +∞)</li></p></main>    |
