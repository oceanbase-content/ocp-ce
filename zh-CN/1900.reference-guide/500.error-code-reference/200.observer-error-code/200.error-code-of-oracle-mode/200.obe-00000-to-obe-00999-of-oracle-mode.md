...
* 解决方式：正确挂载备份介质，确保发起归档/备份/恢复操作的租户的所有 OBServer 节点都能够访问到同一备份介质。挂载 NFS 的详细操作，请参考 [部署 NFS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000004475593)。
...
* 解决方式：如果备份介质为 NFS，请参考 [部署 NFS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000004475593) 按照指定的方式进行挂载；如果备份介质为对象存储，请联系对应的服务提供商。
