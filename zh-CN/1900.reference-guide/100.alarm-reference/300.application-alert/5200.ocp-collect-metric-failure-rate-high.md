...
|---|---|
|machine-translation||
|slug|ocp-collect-metric-failure-rate-high-ocp-server-collects-metrics-with-a-high-failure-rate|
...
* OCP 元数据库租户资源不足，导致 OCP 频繁出现 full GC，可以根据文档排查，并适当扩容，详情请参见，[MonitorDB 资源](../../../300.deployment-guide/100.deploying-enterprise-ocp/300.deployment/100.planning-resources/300.monitordb-resources.md)。
