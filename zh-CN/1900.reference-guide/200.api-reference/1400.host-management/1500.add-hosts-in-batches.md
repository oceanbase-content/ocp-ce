...
| mgragentCpuQuota  | number      | 否  | 2.0                        | ocp_mgragent 的 CPU 配置，需大于等于 0.5C，请按 0.5C 倍数递增，建议最大值为 6C。 |
| mgragentMemoryQuota | Integer    | 否  | 2                         | ocp_mgragent 的内存配置，需大于等于 1GiB，请按 1GiB 倍数递增，建议最大值为 12GiB。 |
