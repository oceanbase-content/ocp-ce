...
| syncStatus  | Enum     | 主备同步状态。取值范围：<li>VALID：有效状态</li><li>DISABLED：禁止同步数据状态</li><li>DISABLED_WITH_READ_ONLY：只读状态</li><li>SYNCHRONIZING：同步中（OceanBase 侧当前该状态）</li><li>UNKNOWN：未知状态</li>  |
