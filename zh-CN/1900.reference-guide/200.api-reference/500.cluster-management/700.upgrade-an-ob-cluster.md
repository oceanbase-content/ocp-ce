...
|---|---|
|machine-translation||
|slug|upgrade-an-oceanbase-cluster-of-api|
...
| zoneRpmList     | Array   | 是    | -             | 可用区目标软件包列表。  |
| ├─zoneNameList  | Array   | 是    | zone1,zone2,zone3   | Zone 名称。 |
| ├─rpmName       | String  | 是    | oceanbase-4.4.0.0-100000682023020119.el7.x86_64.rpm    | RPM 包包名。 |
| ├─packageOperatingSystem | String | 是  | el8       | 软件包操作系统。 |
| operatingSystem | String  | 是    | el7           | 已废弃，后续版本中将删除该参数。 |
  ...
  "zoneRpmList": [
    {
      ...
      "rpmName": "oceanbase-4.4.0.0-100000682023020119.el7.x86_64.rpm",
