...
| DIAG31100 | The {0} attribute for advanced search is invalid. |
| DIAG31101 | The {0} operator for advanced search is invalid. |
| DIAG31102 | The value {0} for advanced search is invalid. |
| DIAG31103 | The UID {0} of the plan is invalid. |
| DIAG31104 | The specified time range exceeds the maximum time interval of {0}. Shorten the time range and try again. |
| DIAG31105 | The query timed out because the time range was too long. Shorten the time range and try again. |
| DIAG31106 | The start time and end time of query is earlier than {0} days before today, please specify a later time interval and try again. |
| DIAG31107 | Deadlock analyze is not supported on current OceanBase with version:{0} |
| DIAG31108 | The new-sql query timed out because the time range was too long. Shorten the time range and try again. |
| DIAG31110 | Info of SQL: {0} has not been collected. |
| DIAG32000 | Outline {0} does not exist. |
| DIAG32001 | Outline {0} already exists. |
| DIAG32002 | The tenant ID does not match the first 20 bits of the OceanBase Database ID. |
| DIAG32003 | Unable to find the SQL text with the SQL ID of {0}. |
| DIAG32004 | Unsupported SQL text. It must contain SELECT, UPDATE, REPLACE, DELETE, or INSERT, followed by a space. |
| DIAG32005 | Table {0} does not exist. |
| DIAG32006 | Index {0} does not exist. |
| DIAG32011 | Can not find plan info of {0} |
| DIAG32013 |  SQL {0} used for outline has syntax error, error message {1} |
| DIAG32015 | Outline binding failed, database {0} does not exist |
| DIAG32017 | Outline binding failed,  database of SQL {0} does not exist |
| DIAG32018 | Outline of OCP has not been adapted to OceanBase version :{0} |
| DIAG36001 | The analyse range of ASH report exceed range, the max analyse range is {0} minutes. |
| DIAG36002 | The analyse start time of ASH report exceed the earliest time, the earliest time should in {0} days. |
| DIAG36003 | The analyse range of ASH report is too small, the minimum range is {0} minutes. |
