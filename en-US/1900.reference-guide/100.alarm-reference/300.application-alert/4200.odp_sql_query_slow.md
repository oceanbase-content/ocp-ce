...
This alert is triggered when slow SQL queries are found in an OBProxy log. In OBProxy, an SQL query with an execution time exceeding 500 ms is considered a slow SQL query.
...
|------------|---------|----------|----------|----------|
| slow_sql_query_count | 0 | 0 seconds  | 60 seconds  | 5 minutes  |
