|slug|ob-tenant-no-frozen-oceanbase-tenant-has-not-been-frozen-for-a-long-time|
|---|---|
...
| --- | --- | --- | --- | --- |
| no_frozen_seconds > 90000 | The time elapsed since the last freeze of a tenant, in seconds. | 90000 (25 hours) | 60 seconds | 5 minutes |
