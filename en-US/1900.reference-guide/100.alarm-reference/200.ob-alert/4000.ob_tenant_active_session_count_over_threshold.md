|slug|ob-tenant-active-session-count-over-threshold|
|---|---|
...
| Collected metric  | ob_session_active_num          |
| Metric expression | sum(ob_session_active_num{@LABELS}) by (@GBLABELS)        |
