|slug|ob-tenant-partition-leader-absent|
|---|---|
...
2. Correct the clock offset. For more information, see [Configure the clock source](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001106067). 
