...
|-----------------|-------------|-------|---------------|----------|
| keyword         | String      | No  | agent                                              | The search keyword for the software package. The package names will be filtered based on this keyword.      |
| type            | StringArray | No  | OB_SERVER_INSTALL_PACKAGE,OB_AGENT_INSTALL_PACKAGE | The type of the software package. Multiple types can be filtered. Valid values: <li>OB_SERVER_INSTALL_PACKAGE: OceanBase packages</li><li>OCP_AGENT_INSTALL_PACKAGE: OCP Agent packages</li><li>OBPROXY_INSTALL_PACKAGE: OBProxy packages</li><li>OB_BACKUP_AGENT_INSTALL_PACKAGE: backup and recovery software packages</li>    |
| version         | StringArray | No  | 3.1.0,3.1.1                                        | The version of the software package. Multiple versions can be filtered.    |
| operatingSystem | StringArray | No  | alios,el7                                          | The operating system type. Multiple types can be filtered.   |
| architecture    | StringArray | No  | x84_64,arm                                         | The system architecture. Multiple architectures can be filtered.      |
