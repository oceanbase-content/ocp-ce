...
Queries the performance statistics of a specific SQL statement within a specified time interval. The performance statistics are represented by multiple sampling points, with each point containing the performance data at a specific timestamp. This interface is used to observe how the SQL performance changes over time.

  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>If a large time interval is specified, the number of sampling points returned approaches 120. </p>
  </main>
...
| executions                  | Integer  | The total number of SQL statement executions during the period.                           |
| execPs                      | Float    | The average number of SQL statement executions per second during the period, with two decimal places.              |
| avgAffectedRows             | Float    | The average number of rows affected by the SQL statement during the period, with two decimal places.                |
...
| failCount                   | Integer  | The total number of SQL statement errors during the period.                           |
| failPercentage              | Float    | The error percentage of the SQL statement during the period. The value range is [0, 1]. The value is retained to four decimal places.     |
| retCode4012Count            | Integer  | The total number of SQL statement timeout errors during the period.                       |
| avgWaitTime                 | Float    | The average wait time of the SQL statement during the period.                           |
| avgWaitCount                | Float    | The average number of wait events of the SQL statement during the period.                          |
...
| missPlanPercentage          | Float    | The plan miss rate of the SQL statement during the period. The value range is [0, 1]. The value is retained to four decimal places.    |
...
| avgUserIoWaitTime           | Float    | The average user I/O event wait time of the SQL statement during the period, in milliseconds.              |
...
| avgDiskReads                | Float    | The average disk read count of the SQL statement during the period.                         |
| retryCount                  | Integer  | The total number of SQL statement retries during the period.                          |
| tableScanPercentage         | Float    | The table scan percentage of the SQL statement during the period.                          |
| strongConsistencyPercentage | Float    | The percentage of strong-consistency transactions of the SQL statement during the period. The value range is [0, 1]. The value is retained to four decimal places. |
| weakConsistencyPercentage   | Float    | The percentage of weak-consistency transactions of the SQL statement during the period. The value range is [0, 1]. The value is retained to four decimal places. |
| avgMemstoreReadRows         | Float    | The average number of rows read by MemStore of the SQL statement during the period.                   |
| avgSsstoreReadRows          | Float    | The average number of rows read by SsStore of the SQL statement during the period.                    |
...
| server          | String    | The server where the SQL statement is executed.                    |
| serverIp          | String    | The IP address of the server where the SQL statement is executed.                    |
| sumCpuTimeMs          | Double    | The total CPU time during the period.                    |
...
Query the performance trend of the cluster ID 1, tenant ID 1001, and SQL ID C9B3A63AFF8F2A408CCF3D5B0F36682D. The time range is from 2020-11-03T19:00:00+08:00 to 2020-11-03T20:00. Query only the performance of SQL in the server ID 2 and database name oceanbase.
