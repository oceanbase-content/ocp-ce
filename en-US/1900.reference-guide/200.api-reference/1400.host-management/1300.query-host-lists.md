...
| kind                   | String      | The host category. Valid values: <li> DEDICATED_PHYSICAL_MACHINE: indicates a physical machine. </li><li> DEDICATED_CONTAINER: indicates a container. </li><li>DEDICATED_ECS: indicates an ECS. </li>     |
