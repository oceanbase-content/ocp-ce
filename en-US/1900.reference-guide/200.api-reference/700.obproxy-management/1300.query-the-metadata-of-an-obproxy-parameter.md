# Query the description of OBProxy parameters
...
The caller needs to be authenticated by OCP.
...
|------------|----------|-----------------------|
| data       | Array    | For more information, see **ParameterInfo data structure**.    |
...
| needRestart         | Bool   | Indicates whether the parameter takes effect after a restart.     |
| readonly            | Bool   | Indicates whether the parameter is read-only.    |
