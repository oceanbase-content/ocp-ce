...
This API is used to create an OceanBase cluster.
...
|-----------|--------|-----|------------------------------------------------|---------|
| name      | String | Yes | foo                                            | The cluster name.     |
...
| password  | String | Yes | bar                                            | The password specified for the root account in the sys tenant of the cluster.      |
| zones     | Object | Yes  | --                                             | --      |
| ├─name    | String | Yes  | zone1                                          | The zone name.       |
| ├─idcName | String | Yes  | idc1                                           | The IDC name.       |
| ├─servers | Array  | Yes  | \[1,2\]                                        | The list of host IDs.     |
| ├─loadType| Enum   | No   | EXPRESS_OLTP                                   | The load type. Valid values: <li>EXPRESS_OLTP</li><li>COMPLEX_OLTP</li><li>HTAP</li><li>OLAP</li><li>KV</li> |
...
| timestamp  | Datetime | The timestamp when the request is completed on the server. |
| duration   | Integer  | The time spent by the server processing the request, in ms. |
| status     | Integer  | The status code that conforms to the HTTP Status standard. |
