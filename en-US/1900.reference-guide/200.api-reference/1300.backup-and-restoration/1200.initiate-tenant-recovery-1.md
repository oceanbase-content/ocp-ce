...
|---|---|
|machine-translation||
|slug|initiate-tenant-recovery-of-api|
...
| ------------ | ------- | ------- | ---------- |
| backupTenantStatus | String | Yes | Backup tenant status. Valid values: <li>ONLINE</li> and <li>OFFLINE</li>. |
...
| \ | ----targetTable | String | No | Target table. This parameter is specified when restoreObj = table. |
...
| \ | ----backupObTenantId | Long | No | The tenant ID in OceanBase Database. |
| \ | ----restoreClusterId | Long | Yes | The ID of the restored cluster. |
