...
| status     | StringArray | No       | RUNNING,FAILED | The status of the task. Valid values: <li>RUNNING: indicates that the task is in progress. </li><li>FAILED: indicates that the task failed. </li><li>SUCCESSFUL: indicates that the task succeeded. </li>    |
