...
| standbyOcpClusterId | Long | No | 100001 | The ID of the OCP cluster where the standby tenant resides. This parameter is required when OCP is in multi-cluster mode. |
