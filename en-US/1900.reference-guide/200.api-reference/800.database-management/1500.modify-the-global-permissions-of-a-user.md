...
|    Parameter     |    Type     | Required |   Example value    |      Description     |
|------------------|-------------|----------|--------------------|-------|
| globalPrivileges | ArrayString | Yes      | \[SELECT, CREATE\] | The list of privileges to be changed to. <li>For MySQL tenants, it is a list of global privileges. </li><li>For Oracle tenants, it is a list of system privileges. </li>    |
