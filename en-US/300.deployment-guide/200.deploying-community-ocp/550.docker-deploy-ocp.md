...
* You have created two connections to OceanBase Database in MySQL mode. We recommend that you use two tenants to store metadata and monitoring data respectively.
   ...
   For more information about how to create an OceanBase cluster, see [Deploy a cluster](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001103572). For more information about how to create an OceanBase Database tenant, see [Create a tenant](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001103995).
