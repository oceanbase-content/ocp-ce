...
MetaDB is used to store persistent data other than monitoring data. It requires a relative small amount of resources. It is recommended to create a separate tenant in OceanBase for MetaDB and allocate a minimum of 2 CPU cores and 4 GiB of memory to this tenant.
...
During the operation of OCP, various performance data of the managed targets, mainly OceanBase clusters, will be collected and stored in MonitorDB. It is recommended to create a separate tenant in OceanBase for MonitorDB and allocate a minimum of 2 CPU cores and 8 GiB of memory to this tenant.
