...
* Your operating system meets conditions listed in the following table.
   ...
   |---------|---------|------|
   | x86_64/ARM aarch64  | RHEL (and compatible RockyLinux, CentOS, etc.) | 7.2 and later |
   | x86_64/ARM aarch64  | Anolis (and compatible Alibaba Cloud Linux, Kylin V10, Unity Operating System (UOS), China Mobile BC-Linux, Linx OS, Zhongke Fangde OS, and others) | 8.4 and later |
   | x86_64/ARM aarch64  | Debian (and compatible Ubuntu, etc.) | 11 and later |
   | x86_64/ARM aarch64  | openSUSE | 12SP3 and later |
   | x86_64/ARM aarch64 | Linx OS | V6.0.99 and later |
