...
* Before you add the server, make sure that you have installed OAT and logged on to it as the super administrator or an O&M engineer. For more information, see [Install OAT](100.install-oat.md).
