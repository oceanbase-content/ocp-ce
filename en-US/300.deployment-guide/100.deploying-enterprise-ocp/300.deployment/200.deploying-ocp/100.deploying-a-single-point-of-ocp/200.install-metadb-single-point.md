...
Before you deploy OceanBase Cloud Platform (OCP), you must create the MetaDB component for OCP in OceanBase Admin Toolkit (OAT). If you want to use a deployed MetaDB, you can take it over to OAT. For more information, see [Take Over MetaDB](https://en.oceanbase.com/docs/common-oat-10000000003539842).
