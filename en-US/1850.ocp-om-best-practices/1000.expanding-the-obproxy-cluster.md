|slug|scale-out-an-obproxy-cluster|
|---|---|
...
* You have added the hosts on which you want to deploy new OBProxies to OceanBase Cloud Platform (OCP) for management. For more information, see [Add a host](../850.host-features/100.manage-a-host/200.add-a-host.md).
