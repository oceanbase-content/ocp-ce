|slug|upgrade-an-oceanbase-cluster|
|---|---|
...
For information about the upgrade procedure, see [Upgrade an OceanBase cluster](../600.cluster-functions/700.upgrade-cluster-version.md).
