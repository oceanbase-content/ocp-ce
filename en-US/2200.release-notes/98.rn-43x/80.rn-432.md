...
**<UI-TERM key="ocp-v2.page.Overview.SqlDiagnosis">SQLs</UI-TERM>** > **SlowSQL**: OCP V4.3.2 supports displaying sample data and displaying detailed parameters of sample data on the details page.
