...
* Optimized the retrieval speed of **<UI-TERM key="ocp-v2.Plan.Component.PlanExecuteTable.Alert">Alerts</UI-TERM>** information on the **<UI-TERM key="ocp-v2.Backup.Component.RestoreNow.BackupAndRestoration">Backup & Restore</UI-TERM>** page in the cluster console.
