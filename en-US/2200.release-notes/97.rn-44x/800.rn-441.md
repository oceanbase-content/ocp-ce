...
* **Cluster management**:
  ...
  * The transparent data encryption (TDE) feature is now compatible with KMS services from third-party vendors such as Jiangnan Tianan, providing users with a more robust data protection solution. Supported OceanBase versions include: [V4.2.5.4, V4.3.0.0), [V4.3.5.2, +∞).
