...
* Added three time ranges to the time selector on the **<UI-TERM key="ocp-v2.Detail.Monitor.Title.PerformanceMonitoring">Performance Monitoring</UI-TERM>** page: **<UI-TERM key="ocp-v2.component.OCPRangePicker.constant.NearlyMinutes">Last 5 Minutes</UI-TERM>**, **<UI-TERM key="ocp-v2.src.constant.log.NearFenZhong.1">Last 10 Minutes</UI-TERM>**, and **<UI-TERM key="ocp-v2.src.constant.backup.LastDays">Last 7 Days</UI-TERM>**. Removed the less frequently used **<UI-TERM key="ocp-v2.component.OCPRangePicker.constant.NearlyMinute">Last 1 Minute</UI-TERM>** option to improve user query efficiency.
