...
* Modifying the proxyro account password is only supported for OBProxy clusters of versions earlier than V4.0.0. For V4.5.0 and later, this operation is not supported.
