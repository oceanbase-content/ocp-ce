...
OCP supports five categories of collection and O&M parameters: SQL diagnostics collection parameters, transaction diagnostics collection parameters, Active Session History (ASH) collection parameters, performance monitoring parameters, and backup parameters.
...
**Performance monitoring collection** provides the basic data for the performance monitoring modules of the cluster, tenants, and OBProxy.
...
**Backup collection** provides the basic data for the backup modules of the cluster and tenants.

| Parameter | Type | Default value | Value range | Description |
|--------|----------|--------|--------|-----------|
| backup.dump.physical.file.timeout | Int    | 30 | [10, 300] | The physical backup file dump timeout, in seconds. |
| backup.storage.s3.use.path.style  | Bool   | true | - | Specifies whether to use path-style access for S3 storage. |
