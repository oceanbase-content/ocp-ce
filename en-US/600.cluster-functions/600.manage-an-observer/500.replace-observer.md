...
5. Specify the relevant information and click **<UI-TERM key="ocp-v2.Detail.Component.ReplaceArbitrationServerDrawer.Replace">Replace</UI-TERM>**.
   ...
   2. Select the substitute host. If no host is available in the drop-down list, you can add one. For more information, see [Add a host](../../850.host-features/100.manage-a-host/200.add-a-host.md).
