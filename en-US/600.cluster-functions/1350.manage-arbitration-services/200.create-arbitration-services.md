...
5. In the **<UI-TERM key="ocp-v2.src.component.ArbitrationServiceSelect.CreateArbitrationService">Create Arbitration Service</UI-TERM>** panel, configure the basic information of the arbitration service.
   ...
   |---------|----------|
   | Host | The host for deploying the arbitration service. You can deploy multiple arbitration service processes on the same host. You can search for hosts by IP address or click [Add a host](../../850.host-features/100.manage-a-host/200.add-a-host.md) in the drop-down list to add an available host.  |
...
The following table describes the startup parameters of the arbitration service of OCP. For more information about the parameters, see [OceanBase Database parameters](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001228473).
