...
1. Log in to the database as an administrator of the `sys` tenant or a user tenant.
   ...
   For more information about how to connect to a database, see [Overview (MySQL mode)](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971653) or [Overview (Oracle mode)](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971676).
