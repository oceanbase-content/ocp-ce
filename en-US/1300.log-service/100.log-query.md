...
* **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Component.LogTypeSelect.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.LogService">Log Services</UI-TERM>**

## Procedure

1. Log in to the OCP console.

2. In the left-side navigation pane, choose **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">Administration</UI-TERM>** \> **Log service**.
