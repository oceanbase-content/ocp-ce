...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.AddRole MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.ObproxyClusterWithExclude.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.page.Log.LogService">Log Services</UI-TERM>**
