|slug|configure-trace-query-parameters|
|---|---|
...
* **<UI-TERM key="ocp-v2.Auth.Role.Detail MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Auth.Role.AddRole.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.LogService">Log Services</UI-TERM>**
