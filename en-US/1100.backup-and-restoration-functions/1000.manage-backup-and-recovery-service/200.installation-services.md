...
* You have added a host as the backup and restore server. For more information, see [Add a host](../../850.host-features/100.manage-a-host/200.add-a-host.md).
